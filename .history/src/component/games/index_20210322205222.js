...
import { getGameById, clearGameById } from '../../store/actions';
		...
		<>
			{game.gameById ? (
				<div className='about_container'>
					...
					<div
						className='image'
						style={{ background: `url(${game.gameById.imagexl})` }}
					></div>
					<Button variant='primary' className='mt-3'>
						Play game now
					</Button>
					<div className='author'>
						<Moment format='DD MMMM'>{game.gameById.createdAt}</Moment>
					</div>
					<div className='author'>
